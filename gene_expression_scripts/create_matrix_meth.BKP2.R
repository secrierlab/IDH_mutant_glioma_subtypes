## 
#Efficient extraction of methylation values using a gene-list and TCGA data
##

# work_dir: location methylation data
# genes_to_use: list of genes
# nThread: number of thread to use for the analasyis

# output: A matrix with the beta-value for the genes of interest
...
file_to_read<-dir()
tab_genes_islands<-fread(file_to_read,select=c(6,11),data.table=T,stringsAsFactors=FALSE,sep="\t")
