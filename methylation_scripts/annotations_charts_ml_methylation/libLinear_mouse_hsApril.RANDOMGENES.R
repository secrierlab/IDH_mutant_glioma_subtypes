libLinear_mouse_hsAprilRANDOM<-function(input_for_ml3,input_mm2,list_ann=list_ann,prefix_output=NA,type_tumours="LGG",suffix_output){
  ...
  res_liblinear<-vector(mode="list",5)
  res_liblinear[[1]]<-mat_final
  res_liblinear[[2]]<-nsamples_test
  res_liblinear[[3]]<-all_performances
  res_liblinear[[4]]<-all_confmatrix
  res_liblinear[[5]]<-all_performances2
